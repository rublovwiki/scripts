This repository contains the source code for [Rublov](https://en.wikipedia.org/wiki/User:Rublov)'s [user scripts](https://en.wikipedia.org/wiki/Wikipedia:User_scripts) on Wikipedia.
